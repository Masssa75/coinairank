...
export default function ProjectDetailPage({ params }: { params: { symbol: string } }) {
  ...
  const sections = [
    ...
    { title: 'Vision Story', content: analysis.vision_story },
    { title: 'Innovation Story', content: analysis.innovation_story },
    { title: 'Market Story', content: analysis.market_story },
    { title: 'Team Story', content: analysis.team_story },
    { title: 'Decentralization Story', content: analysis.decentralization_story },
    { title: 'Critical Flaw', content: analysis.critical_flaw },
    { title: 'Risk Story', content: analysis.risk_story },
